(async () => {
  const POSTS = [{"text": "Göz sevileni arar. Sohbet sevilenle yapılır. Dua sevilene edilir. Uyku sevilen için kaçar. Dünya sevilenle cennet olur.", "likes": 11}, {"text": "ne garip bir yol dünya huzura yürümek isterken hüzüne takılıyor ayaklarımız ne yazık", "likes": 13}, {"text": "Sevdiklerinize zaman ayırın.! Yoksa zaman sizi ayırır.", "likes": 9}];
