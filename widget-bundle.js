(async () => {
  const POSTS = [{"text": "Favorieten Allaha A teslim olmuş gönül ne mekam ister ne de alkış ona rabbimin rızası yeter dünya ahiret", "likes": 6}, {"text": "Favorieten dua temiz bir kalbin sesini Allaha duyurmaktır yürekten istediginiz ne varsa hayırlısıyla ömrünüze nasip olsun cuma saatinde", "likes": 5}, {"text": "Favorieten suyun sesi taşlara çarpa güzelleşir insan da imtihanlarla olgunlaşır sabırla güçlenir duayla huzur bulur belki de bugün seni yoran şey yarın en büyük hayrın olacaktır allah kalbimizi sabır ömrümüzü hayır nasip etsin Allah yolundan ayırmasın ,", "likes": 6}, {"text": "Favorieten Güzelliği bulmak için Tüm dünyayı dolaşsak da; Onu içimizde taşımıyorsak asla bulamayız... Rabbim güzellikleri eksik etmesin hayatınızdan", "likes": 9}];
