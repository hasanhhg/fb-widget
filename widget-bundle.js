(async () => {
  const POSTS = [{"text": "Favorieten bu zikiri cekene kimse ugraşamaz allahın izninle yeterki okuyun, ya celilü l mütekebbiru ala külli şeyin fel adlü emruhü ves sıdku va duhü.", "likes": 11}];
