(async () => {
  const POSTS = [{"text": "Favorieten İnsan bazen bir yabancı gibi uzaktan bakıyor yaşamadaki yaşamak istediklerini hayallerini boşa giden bir ömre", "likes": 1}, {"text": "Favorieten Acı deyip geçme güzel tarafları vardır canın yanar ama sonunda kime güvenip kime güvenemeyeceğini çok iyi anlarsın be usta", "likes": 2}, {"text": "Favorieten Asalet dik duruşta, sabır ise her yokuştadır. Nurullah Dönmez en 12 anderen", "likes": 13}, {"text": "Favorieten Kolay iyileşmiyor değer verdiğin insanların açtığı yaralar… Kızgınlık geçiyor da kırgınlık nereye koysan sığmıyor", "likes": 13}, {"text": "Favorieten BİR DERDİNİZ Olduğunda, ANLATACAK Kimsenin Olmadığını Değil, Sizi ANLAYACAK Kimsenin Olmadığını Anladığınız AN YALNIZSINIZDIR...", "likes": 12}];
