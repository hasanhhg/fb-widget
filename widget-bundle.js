(async () => {
  const POSTS = [{"text": "Allah'ım, \"Ya Kâfî, Ya Muğnî, Ya Fettâh, Ya Rezzâk\" isimlerinin hürmetine; ihtiyaçlarımızı gider, hayırlı kapılar aç, helal ve bereketli rızık nasip eyle. Bizleri Sen'den başkasına muhtaç eyleme. Âmin.41 sefer", "likes": 2}, {"text": "Cuma; duaların, istiğfarın ve salavatın bereketiyle gönüllerin huzur bulduğu mübarek bir gündür. Bugün bu güzel zikri ve duayı okuyarak Rabbimize yönelelim. Okunacak Dua: Subhânallâhi ve bihamdihî.", "likes": 9}, {"text": "Gönül dostlarım; hayatın çarkları ağırlaştığında, düğümler çözülmediğinde ve beden derman aradığında; Rabbimizin ism-i şeriflerine sığınmak en büyük devadır. Bugün, hem zorlukların kolaylaşması hem de manevi ve maddi dertlerin hastalıkların şifa bulması için ya latif ya mucip ya hay ya vacid tecrübe edilmiş", "likes": 9}, {"text": "Her Cuma yeni bir umut, her dua yeni bir başlangıçtır. Hayırlı Cumalar. Nurullah Dönmez en 17 anderen", "likes": 18}, {"text": "Ayak altında çatlama varsa sadece 3 malzeme 10 adet aspirin 2 adet limon 1 bardak zeytin yağı", "likes": 5}];
