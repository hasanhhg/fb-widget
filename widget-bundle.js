(async () => {
  const POSTS = [{"text": "Favorieten Öyle ya da böyle Seneler akıp geçiyor Yaş almak önemli değil de En güzel yılları yaşayamadan yaşlanmak İşte o koyuyor en çok insana.", "likes": 0}, {"text": "Favorieten Bir ayete takılı kaldım diyor ki; İnsanlar tesadüfen karşılaşmaz, onları karşılaştıran Allah’tır.. Karşılaştığımız kişileri kimi imtihan,", "likes": 0}, {"text": "Favorieten Hiç Bir Şeyi Ertelemeyin Yaşıyorken Bilin Sevdiklerinizin", "likes": 2}, {"text": "Favorieten \"Ey benim dağ gibi görünüp, Çocuk gibi ağlayan yüreğim.. Yorulduğunu biliyorum, Ama belli etme", "likes": 0}, {"text": "Favorieten Allaha A teslim olmuş gönül ne mekam ister ne de alkış ona rabbimin rızası yeter dünya ahiret", "likes": 14}];
