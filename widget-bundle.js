(async () => {
  const POSTS = [{"text": "Göz sevileni arar. Sohbet sevilenle yapılır. Dua sevilene edilir. Uyku sevilen için kaçar. Dünya sevilenle cennet olur.", "likes": 12}];
