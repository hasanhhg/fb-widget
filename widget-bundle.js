(async () => {
  const POSTS = [{"text": "BÜYÜK HÂCET DUASI", "likes": 5}, {"text": "sunu hiç unutmayın ilahi adalette zaman aşımı yoktur o bir gün mutlaka tecelli edecektir", "likes": 9}, {"text": "Hiçbir şeye olacakmış gibi gönül bağlama.! Ve \"olsun\" diye kovalama, Hayırlısı de.. Ne kadar çok uğraşırsan, o kadar kolay kaybedersin unutma..", "likes": 5}, {"text": "40 Gün Sabah Namazından Sonra Okuyanın İstediği Gerçekleşir Okunuşu Allâhümme salli alê seyyidinê Muhammedin abdike ve rasûlike ve halîlike ve habîbike salâten ergabiha merakiyel ihlasi ve enalü biha ğayetel ihtisası ve sellim tesliymen adede ma ahata bihi ilmüke ve ehsahü kitabüke küllema zekera kezzakirune ve ğafele an zikrihil ğafilun", "likes": 7}, {"text": "Başağrısı İçin Okunacak Dua - Bismillahirrahmânirrahîm Elif lam mim, Allahü la ilahe illa hüvel hayyül kayum, nezzele aleykel kitabe bil hakkı musadikan lima beyne yediyhi ve enzelet terate vel incile min kablü hüden lin nasi ve enzelel furkane innellezine keferu bi ayatillahi lehüm azabün şedidün vallahü azizün züntikam Uhruc minha mez'umen medruhan le emleenne cehenneme minke ve mimmen tebiake minhüm ecmeiyn.", "likes": 5}];
