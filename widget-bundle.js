(async () => {
  const POSTS = [{"text": "Bazen ne yaparsak yapalım işler ters gider, evde sebepsiz bir huzursuzluk başlar, üzerimizde koca bir dağ taşıyormuşuz gibi hissederiz... Kem gözler ve haset, insanın hayatındaki bereketi ve huzuru sessizce çalan en tehlikeli yüktür. Peygamber Efendimiz (s.a.v) rahatsızlandığında, Cebrail (a.s) ona gelerek bizzat şu muazzam şifa ve korunma duasını okumuştur: Okunuşu: Nurullah Dönmez, Yusuf Albayrak en 17 anderen", "likes": 19}, {"text": "Yetmiş İki Dertten Kurtulma Duâsı Arapçası: لَا حَوْلَ وَلَا قُوَّةَ إِلَّا بِاللَّهِ وَلَا مَنْجَا مِنَ اللَّهِ إِلَّا إِلَيْهِ Okunuşu:", "likes": 6}, {"text": "Bismillahirrahmanirrahim \"Rabbeneftah beynena ve beyne kavmina bil-hakkı ve ente hayrul-fatihîn.\" \"Rabbimiz! Bizimle kavmimiz arasında hak ile hüküm ver. Sen hüküm verenlerin en hayırlısısın.\" A'râf Suresi 89.", "likes": 12}, {"text": "Ömrü Kadar Rızkı rzkBüyüklerden Hatemül Asam hazretleri, bir yolculuğa çıkacaktı. Ailesine: — Ben sefere çıkacağım… Sana ne kadar yiyecek bırakayım, dedi. Hanımı da hakiki mütevekkillerdendi. Kocasına: — Yaşayacağım zamana yetecek kadar rızık isterim, diye cevap verdi.", "likes": 11}, {"text": "“Allah’ım, acizlikten, tembellikten, cimrilikten, ihtiyarlıktan ve kabir azabından Sana sığınırım. Allah’ım, nefsime takvasını ver ve onu temizle. Onu en iyi temizleyecek olan Sensin. Onun sahibi ve mevlâsı Sensin. Allah’ım, faydasız ilimden, korkmayan kalpten, doymayan nefisten ve kabul olunmayan duadan Sana sığınırım", "likes": 20}, {"text": "Bir kul gözyaslariyla huzuruma af dilemeye gelirse,ben onu affetmemekten haya ederim.\" diyor YARADAN. Affedilenlerden olmak duasiyla Bayram Köksal en 11 anderen", "likes": 12}];
