(async () => {
  const POSTS = [{"text": "Favorieten Asalet dik duruşta, sabır ise her yokuştadır. Nurullah Dönmez en 10 anderen", "likes": 11}, {"text": "Favorieten Kolay iyileşmiyor değer verdiğin insanların açtığı yaralar… Kızgınlık geçiyor da kırgınlık nereye koysan sığmıyor", "likes": 12}, {"text": "Favorieten BİR DERDİNİZ Olduğunda, ANLATACAK Kimsenin Olmadığını Değil, Sizi ANLAYACAK Kimsenin Olmadığını Anladığınız AN YALNIZSINIZDIR...", "likes": 12}, {"text": "Favorieten Yok sayıldığın yerlerde var olmak için çabalama yorulursun.", "likes": 13}, {"text": "Favorieten Ne kadar zengin olsanda Bir insanın sevgisine muhtaçsın..!! Hayat \"Para\" ile değil, Sevgiyle \"Anlam\"bulur.", "likes": 12}];
