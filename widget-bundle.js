(async () => {
  const POSTS = [{"text": "unutmayın her imtihanda allah ın sizlere bir anahtar uzattıgını unutmayın rahmet kapısına zahmet anahtarıyla girilir kardeşlerim", "likes": 1}, {"text": "Bir yalan, bin doğruyu şüpheye düşürür. Ve şüphe dünyanın en lanet duygusudur, her şeyi yavaş yavaş bitirir", "likes": 0}, {"text": "unutmayın sevgi allah tarafından insana verilen bir nimettir kiminin elinde heba kimininde kalbinde vefa olur", "likes": 0}, {"text": "Varsın, hak kapını kimse çalmasın, Dost bildiklerinde, vefâ kalmasın, Varsın, selâmını kimse almasın; Olmaz bir zerresi, Mîzan'da heder,", "likes": 0}];
