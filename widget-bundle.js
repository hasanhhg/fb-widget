(async () => {
  const POSTS = [{"text": "Göz sevileni arar. Sohbet sevilenle yapılır. Dua sevilene edilir. Uyku sevilen için kaçar. Dünya sevilenle cennet olur.", "likes": 4}, {"text": "ne garip bir yol dünya huzura yürümek isterken hüzüne takılıyor ayaklarımız ne yazık", "likes": 8}, {"text": "Sevdiklerinize zaman ayırın.! Yoksa zaman sizi ayırır.", "likes": 5}, {"text": "Özür dileyenin özrünü kabul et Allah'ı tanıyan kişi insanlardan özür diler. Özür dileyenin özrünü kabul eyle. Sana eziyet edeni affedip tatlı ve yumuşak söyle. Elinden geldiği kadar kusurları affet,", "likes": 6}];
