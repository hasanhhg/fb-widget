(async () => {
  const POSTS = [{"text": "Allah'ın yazdığı kaderini yaşamaktan korkma... Zahmette rahmet vardır, unutma..", "likes": 9}, {"text": "biz hep aradıklarımızı yanlış yerde bulmaya çalıştık buldugumuz yanlış insanlarda dogrularımızı harcadı böyleymiş", "likes": 3}, {"text": "Allah ;size dünyayı Onunla ahireti arayasınız diye verdi, Ona meyledesiniz diye değil", "likes": 9}, {"text": "İNSANIN ; Hayrı çoğalırsa Meleklere karışır , Şerri çoğalırsa şeytana karışır,", "likes": 5}, {"text": "Geceleyin öyle bir zaman vardır ki, müslüman bir kimse o zamana rastlayıp Allah’tan dünya ve âhirete dair hayırlı bir şey dilerse, Allah ona dilediğini verir. Bu her gece böyledir.”", "likes": 3}, {"text": "Ey yerin Göğün sabihi Güzel ALLAH ım şu anda bu mesajı okuyan kuluna borcu varsa hastalığı hastası varsa. 99 .isminin hürmetine sen şifalar ver. Hiç ummadığı yerden helal rızık kapıları açarak borcundan kurtar Onun evine bolluk bereket dirlik düzen huzur ver. Evlatlarıyla mutlu et..", "likes": 15}, {"text": "Bismillahirrahmanirrahim '' Ya zel celali vel ikram. Ya zet tavli vel inam. La ilahe illa ente zahrellacine ve carel müstecirine ve emanel haifine vehiczel mütevekkilin ne muradın varsa olması için", "likes": 11}, {"text": "“Allah’ım, Sen benim işlediğim bütün gizli ve açık şeyleri bilirsin, mazeretimi kabul eyle. Hacetimi bilirsin, isteğimi yerine getir. İçimdekini bilirsin, günahımı bağışla. Allah’ım, Senden kalbimi kaplayacak iman.", "likes": 8}, {"text": "la ilahe illallahu kable külli şey in la ilahe illallahu ba dekülli şeyin la illahe illallahu yebka rabbuna ve yefna küllü şey in sıkıntı büyüyü olanlar okusun allahın izninle herderten kurtulur.", "likes": 10}, {"text": "Yolun var mı da, yoldaş bulamadım diye feryat ediyorsun..? Gönlüne erdin mi de, gönüldaşım nerede diye sızlanıyorsun..? Önce kendini bir bul bakalım..! Ayağında diken yarası olmayan, sinesine gül kokusu süremez..!", "likes": 10}];
