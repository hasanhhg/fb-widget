(async () => {
  const POSTS = [{"text": "Favorieten Kolay iyileşmiyor değer verdiğin insanların açtığı yaralar… Kızgınlık geçiyor da kırgınlık nereye koysan sığmıyor", "likes": 0}, {"text": "Favorieten BİR DERDİNİZ Olduğunda, ANLATACAK Kimsenin Olmadığını Değil, Sizi ANLAYACAK Kimsenin Olmadığını Anladığınız AN YALNIZSINIZDIR...", "likes": 1}, {"text": "Favorieten Yok sayıldığın yerlerde var olmak için çabalama yorulursun.", "likes": 1}, {"text": "Favorieten Ne kadar zengin olsanda Bir insanın sevgisine muhtaçsın..!! Hayat \"Para\" ile değil, Sevgiyle \"Anlam\"bulur.", "likes": 1}, {"text": "Favorieten Herkesin terazisi farklıdır kimi parayı tartar Kimi makamı Ben ise insanın", "likes": 1}];
