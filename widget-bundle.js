(async () => {
  const POSTS = [{"text": "Favorieten İnsan bazen bir yabancı gibi uzaktan bakıyor yaşamadaki yaşamak istediklerini hayallerini boşa giden bir ömre", "likes": 2}];
