(async () => {
  const POSTS = [{"text": "BÜYÜK HÂCET DUASI", "likes": 5}, {"text": "sunu hiç unutmayın ilahi adalette zaman aşımı yoktur o bir gün mutlaka tecelli edecektir", "likes": 8}, {"text": "Hiçbir şeye olacakmış gibi gönül bağlama.! Ve \"olsun\" diye kovalama, Hayırlısı de.. Ne kadar çok uğraşırsan, o kadar kolay kaybedersin unutma..", "likes": 5}, {"text": "40 Gün Sabah Namazından Sonra Okuyanın İstediği Gerçekleşir Okunuşu Allâhümme salli alê seyyidinê Muhammedin abdike ve rasûlike ve halîlike ve habîbike salâten ergabiha merakiyel ihlasi ve enalü biha ğayetel ihtisası ve sellim tesliymen adede ma ahata bihi ilmüke ve ehsahü kitabüke küllema zekera kezzakirune ve ğafele an zikrihil ğafilun", "likes": 7}];
