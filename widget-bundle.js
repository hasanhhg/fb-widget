(async () => {
  const POSTS = [{"text": "Cuma; duaların, istiğfarın ve salavatın bereketiyle gönüllerin huzur bulduğu mübarek bir gündür. Bugün bu güzel zikri ve duayı okuyarak Rabbimize yönelelim. Okunacak Dua: Subhânallâhi ve bihamdihî.", "likes": 2}, {"text": "Gönül dostlarım; hayatın çarkları ağırlaştığında, düğümler çözülmediğinde ve beden derman aradığında; Rabbimizin ism-i şeriflerine sığınmak en büyük devadır. Bugün, hem zorlukların kolaylaşması hem de manevi ve maddi dertlerin hastalıkların şifa bulması için ya latif ya mucip ya hay ya vacid tecrübe edilmiş", "likes": 4}, {"text": "Her Cuma yeni bir umut, her dua yeni bir başlangıçtır. Hayırlı Cumalar.", "likes": 7}, {"text": "Ayak altında çatlama varsa sadece 3 malzeme 10 adet aspirin 2 adet limon 1 bardak zeytin yağı", "likes": 4}, {"text": "Allah’a Yönelen Hiçbir Dua Karşılıksız Değildir… Kalpten edilen her dua, Rabbimizin katında değerlidir. Kimi duası hemen kabul olur, kimi ise en hayırlı vakte bırakılır. Bu güzel zikri samimiyetle okuyup ardından gönlünüzden geçenleri Rabbimize emanet edebilirsiniz. ya rahman ya rahim Allah, edilen tüm duaları hayırlısıyla kabul eylesin.", "likes": 11}, {"text": "Kâbe'de bazen bir köşeye çekilip sessizce ağlayan, bazen secdeye kapanıp hıçkıra hıçkıra dua eden insanlara şahit olursunuz. Çünkü oraya gidenlerin çoğu sadece bir yolculuk yapmaya gelmez. Kimi affedilmeyi ister, kimi yıllardır dilinden düşmeyen duasını Rabbine arz eder. Kimi kalbinde taşıdığı yüklerle gelir, kimi yorgundur, kimi çaresizdir, kimi ise sadece Rabbine kavuşmanın hasretini yaşar.", "likes": 15}];
