(async () => {
  const POSTS = [{"text": "Favorieten Kalp Allaha yaklaştıkca basireti artar dünyaya yaklaştıkca körlügü çogalır takva kalbin kandilidir allah ın nuru onunla parlar. Nurullah Dönmez en 12 anderen", "likes": 13}];
